...
use routes::{
    graph::{graph_data, graph_page}, history::historical_graph, index::current_readings_json, readings::create_reading
};
...
async fn main() {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .route("/api/current", web::get().to(current_readings_json))
